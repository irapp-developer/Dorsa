...
public class Fragment_Add_Child_Details extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageView BTN_Add = (ImageView) pView.findViewById(R.id.frg_add_kid_details_btn_add);
        ...
        BTN_Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!isAvatarSelected) {
                    ...
                    Toast.makeText(getContext(), "جنسیت کودک را انتخاب نمایید", Toast.LENGTH_SHORT).show();
